...
public class TestUserOrderDAODelete extends DBTestCase {
    public TestUserOrderDAODelete(String testName) throws Exception {
        super(testName);
