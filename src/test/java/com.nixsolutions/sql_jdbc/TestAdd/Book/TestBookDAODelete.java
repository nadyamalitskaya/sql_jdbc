...
public class TestBookDAODelete extends DBTestCase {
    public TestBookDAODelete(String testName) throws Exception {
        super(testName);
    ...
    @Override protected IDataSet getDataSet() throws Exception {
        return new FlatXmlDataSetBuilder().build(new FileInputStream(
                "./src/test/java/testData/BookUpdateDeleteDataSet.xml"));
    ...
    public void testDeleteBook() throws Exception {
        ...
        IDataSet expectedDataSet = new FlatXmlDataSet(new File(
                "./src/test/java/expectedTestData/BookDeleteExpected.xml"));
