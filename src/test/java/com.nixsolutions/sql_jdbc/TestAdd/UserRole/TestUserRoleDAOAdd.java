...
public class TestUserRoleDAOAdd extends DBTestCase {
    public TestUserRoleDAOAdd(String testName) throws Exception {
        super(testName);
    ...
    @Override protected IDataSet getDataSet() throws Exception {
        return new FlatXmlDataSetBuilder().build(new FileInputStream(
                "./src/test/java/testData/UserRoleAddDataSet.xml"));
    }
    ...
    public void testAddUserRole() throws Exception {
        ...
        userRoleDAOInterface.add(userRole);
        userRoleDAOInterface.add(userRole1);
