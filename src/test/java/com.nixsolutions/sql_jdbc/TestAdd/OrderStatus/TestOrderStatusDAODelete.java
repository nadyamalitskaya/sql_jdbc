...
public class TestOrderStatusDAODelete extends DBTestCase {
    public TestOrderStatusDAODelete(String testName) throws Exception {
        super(testName);
    ...
    @Override protected IDataSet getDataSet() throws Exception {
        return new FlatXmlDataSetBuilder().build(new FileInputStream(
                "./src/test/java/testData/OrderStatusUpdateDelete.xml"));
