...
public class TestStatusCommentDAODelete extends DBTestCase {
    public TestStatusCommentDAODelete(String testName) throws Exception {
        super(testName);
