...
public class TestStatusCommentDAOUpdate extends DBTestCase {
    public TestStatusCommentDAOUpdate(String testName) throws Exception {
        super(testName);
    ...
    @Override protected IDataSet getDataSet() throws Exception {
        return new FlatXmlDataSetBuilder().build(new FileInputStream(
                "./src/test/java/testData/StatusCommentUpdateDelete.xml"));
    }
    ...
    public void testUpdateCompositionComment() throws Exception {
        ...
        StatusComment statusComment = statusCommentDAOInterface.getById(1);

        statusComment.setComment("Very bad!");
        statusCommentDAOInterface.update(statusComment);

        IDataSet databaseDataSet = getConnection().createDataSet();
        ITable actualTable = databaseDataSet.getTable("status_comment");
        IDataSet expectedDataSet = new FlatXmlDataSet(new File(
                "./src/test/java/expectedTestData/StatusCommentUpdateExpected.xml"));
