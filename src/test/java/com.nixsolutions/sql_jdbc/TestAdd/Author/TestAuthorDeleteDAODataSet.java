...
public class TestAuthorDeleteDAODataSet extends DBTestCase {

    public TestAuthorDeleteDAODataSet(String testName) throws Exception {
        super(testName);
