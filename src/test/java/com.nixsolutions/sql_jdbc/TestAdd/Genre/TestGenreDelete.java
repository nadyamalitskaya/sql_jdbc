...
public class TestGenreDelete extends DBTestCase {
    public TestGenreDelete(String testName) throws Exception {
        super(testName);
    ...
    public void testDeleteGenre() throws Exception {
        ...
        IDataSet expectedDataSet = new FlatXmlDataSet(
                new File("./src/test/java/expectedTestData/GenreDelete.xml"));
