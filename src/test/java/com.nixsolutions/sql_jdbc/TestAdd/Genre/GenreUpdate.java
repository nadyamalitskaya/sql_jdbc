...
public class GenreUpdate extends DBTestCase {
    public GenreUpdate(String testName) throws Exception {
        super(testName);
    ...
    @Override protected IDataSet getDataSet() throws Exception {
        return new FlatXmlDataSetBuilder().build(new FileInputStream(
                "./src/test/java/testData/GenreUpdateDelete.xml"));
    }
    ...
    public void testUpdateGenre() throws Exception {
        ...
        IDataSet expectedDataSet = new FlatXmlDataSet(new File(
                "./src/test/java/expectedTestData/GenreUpdateExpected.xml"));
